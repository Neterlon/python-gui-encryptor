...
ALPHABETS = [("ABCDEFGHIJKLMNOPQRSTUVWXYZ .,_", "English"),  # English alphabet
             ...
             ("АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ _,!.", "Ukrainian "),  # Ukrainian alphabet
             ("АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ ,!", "Ukrainian (Perfect Square)"),  # Ukrainian alphabet (Number of alphabetic characters is a Perfect Square)
             ("АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ .,-", "Ukrainian (37 characters)")  # Ukrainian alphabet with 37 charaters
             ]
